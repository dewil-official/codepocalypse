...
DOWNSTAIRS = {
    "stairs-or-elevator": point(text=MSG["stairs-or-elevator"], choice_type="list", choices=[
        choices.sub_choice(name="1. Elevator", cmds=["Elevator", "elevator", "1", "one"], next_place="downstairs_elevator"),
        choices.sub_choice(name="2. Stairs", cmds=["Stairs", "stairs", "2", "two"], next_place="downstairs_stairs"),
    ]),
    "elevator": point(text=MSG["elevator"], choice_type="txt", nxt="outside_intro"),
    "stairs": point(text=MSG["stairs"], choice_type="txt", nxt="upstairs_join-conversation"),
}
